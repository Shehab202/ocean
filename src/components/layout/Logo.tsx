  ...
  return (
    <Link href="/" className=" flex  gap-1">
      ...
      <div className="relative flex align-center">
        <h1 className="text-lg capitalize md:text-2xl text-white font-bold  hover:text-sky-200  transition-all transition-discrete hover:duration-150 ease-in cursor-pointer">ocean</h1>
